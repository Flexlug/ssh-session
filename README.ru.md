...
Полное описание — в [`SKILL.md`](skills/ssh-session/SKILL.md), это же файл читает
агент, — и в соседних файлах `references/`, которые он открывает по мере
надобности: подводные камни, таблица диагностики и коды возврата, интерактивные
приглашения и TUI, параллельные сессии, особенности платформ и внутреннее устройство.
